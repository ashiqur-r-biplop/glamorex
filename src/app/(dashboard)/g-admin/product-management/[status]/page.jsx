      ...
      <div className="my-8 bg-slate-50 shadow rounded p-5">
        ...
        <div className="relative ">
          <ul className="flex gap-5 items-stretch my-5 py-2">
            <TapLink href="/g-admin/product-management/all_products">
              All Products
            </TapLink>
            <TapLink href="/g-admin/product-management/pending">
              Pending
            </TapLink>
            <TapLink href="/g-admin/product-management/approved">
              Approved
            </TapLink>
            <TapLink href="/g-admin/product-management/featured">
              Featured
            </TapLink>
            <TapLink href="/g-admin/product-management/rejected">
              Rejected
            </TapLink>
          </ul>
