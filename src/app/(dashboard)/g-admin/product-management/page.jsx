        ...
        <div className='my-8 bg-slate-50 shadow rounded p-5'>
            ...
            <div className='relative '>
                    <ul className='flex gap-5 items-stretch my-5 py-2'>
                        <li className='border-b-2 border-[#0621bb] text-[#0621bb] py-2 uppercase'>All Products</li>
                        <li className='uppercase py-2'>Pending</li>
                        <li className='uppercase py-2'>Approved</li>
                        <li className='uppercase py-2'>Featured</li>
                        <li className='uppercase py-2'>Rejected</li>
                    </ul>
