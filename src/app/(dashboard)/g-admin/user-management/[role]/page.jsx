...
const UserManagementPage = () => {
    ...
    const updateOrderStatus = (role, userId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axiosSecure.patch("/admin/update-user-role", data)
                .then(res => {
    ...
    const search = (e) => {
        axiosSecure(`/admin/search?query=${e.target.search_text.value}`)
        .then(res => {
            setUsers(res.data)
        })
    }
        ...
        <div className='my-8 bg-slate-50 shadow rounded p-5'>
            ...
            <div className='relative '>
                    <ul className='flex gap-5 items-stretch my-5 py-2'>
                        <TapLink href="/g-admin/user-management/all_users">All Users</TapLink>
            ...
            <form  onSubmit={search} className='relative mx-auto w-[80%] flex justify-center my-8'>
                <input name='search_text' placeholder='search here...' type='text' className='bg-white py-3 w-full pl-14 border-2 rounded-full outline-none border-stone-300 text-black' /> <button type='submit' className='absolute top-1/2 -translate-y-1/2 left-5 text-stone-300'><FaSearch></FaSearch></button> 
                </form>
