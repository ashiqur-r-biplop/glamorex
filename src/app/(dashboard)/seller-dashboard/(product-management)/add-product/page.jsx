...
const AddProductPage = () => {
  ...
  const colorsSums = selectedColors.reduce(
    (acc, colorObj) => acc + Object.values(colorObj)[0],
    0
  );
  const sizesSums = selectedSizes.reduce(
    (acc, sizeObj) => acc + Object.values(sizeObj)[0],
    0
  );
  ...
  const onSubmit = (data) => {
    ...
    console.log(product);
    axiosSecure
      .post("/seller/add-new-product", { product })
      .then((res) => {
  ...
  const isGeneralInfoDone =
    ...
    (isColorsPass ? selectedColors?.length : true) &&
    (isSizePass ? selectedSizes?.length : true);
                          ...
                          {categories[watch("category")]?.[
                            ...
                            return (
                              ...
                              >
                                ...
                                {selectedColors.some((sColor) =>
                                  sColor.hasOwnProperty(color)
                                ) && (
                                  <input
                                    type="number"
                                    placeholder="Quantity..."
                          ...
                          {categories[watch("category")]?.[
                            ...
                            return (
                              ...
                              >
                                ...
                                {selectedSizes.some((sSize) =>
                                  sSize.hasOwnProperty(size)
                                ) && (
                                  <input
                                    type="number"
                                    placeholder="Quantity..."
