            ...
            <div className='min-h-screen grid grid-col-1 md:grid-cols-2 gap-4 xl:gap-8 items-center my-container'>
                ...
                <div className="p-10 bg-slate-900 bg-opacity-75 shadow rounded">
                    <form onSubmit={handleSubmit(handleSigninFunc)} className='space-y-3'>
                        ...
                        <button className='my-btn-one w-full' type='submit'>Signin</button>
                        <p className="text-sm font-light text-slate-300">
                            New user? <Link href='/signup' className="font-medium text-primary-600 hover:underline dark:text-primary-500">Signup</Link>
                        </p>
                    ...
                    <div className='flex justify-evenly gap-4 flex-col sm:flex-row'>
                        <button className='my-btn-one-outline flex items-center justify-center'> <FaGoogle className='mr-2'></FaGoogle> Google</button>
                        <button className='my-btn-one-outline flex items-center justify-center'> <FaGithub className='mr-2'></FaGithub> Github</button>
                    </div>
