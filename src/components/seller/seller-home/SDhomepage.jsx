        ...
        <div className="flex gap-3 justify-between items-center mb-3">
          ...
          <div className="relative">
            <input
              placeholder="Filter..."
              type="text"
              className="my-inp !bg-[#081229] !pl-8 !text-slate-50"
            />{" "}
            <span className="absolute top-1/2 -translate-y-1/2 left-2 text-slate-50">
              <FaSearch></FaSearch>
            </span>{" "}
          </div>
        </div>
              ...
              {invoices.map((invoice, ind) => {
                ...
                return (
                  <tr key={ind}>
                    ...
                    <td>{customerName}</td>
                    <td>
                      {itemsName.map((item, ind) => (
                        <span
                          key={ind}
                          className="mx-2"
                          style={{ color: itemsNameColor[ind] }}
                        >
                          {item}
                        </span>
                      ))}
